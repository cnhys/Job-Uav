...
public class RefundUtil {
	...
	public static void main(String[] args) {
		...
		wechatRefund("H0083311820",1);//第一个参数是商户订单号，第二个参数是总金额（double型，以“元”为单位）
	}
...
*/		
		...
		//微信公众平台文档：“基本配置”--》“开发者ID”
		String appid ="wx2d4429ba5009453a";
		//微信公众平台文档：“基本配置”--》“开发者ID”ww
		String appsecret = "31b07294c0d8346c8168e7be5391d2f0";
		//商户号
		//微信公众平台文档：“微信支付”--》“商户信息”--》“商户号”，将该值赋值给partner
		String mch_id = "1487804622";
		String op_user_id = mch_id;//就是MCHID
		//微信公众平台："微信支付"--》“商户信息”--》“微信支付商户平台”（登录）--》“API安全”--》“API密钥”--“设置密钥”（设置之后的那个值就是partnerkey，32位）
		String partnerkey = "b6c4c6c139e04a3baa46835d64291c09";
