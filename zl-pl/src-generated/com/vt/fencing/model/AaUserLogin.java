...
public class AaUserLogin {
	...
	public String getUserFszh() {
		return userFszh;
	}

	public void setUserFszh(String userFszh) {
		this.userFszh = userFszh;
	}
	...
	public String getUserUavIds() {
		return userUavIds;
	}

	public void setUserUavIds(String userUavIds) {
		this.userUavIds = userUavIds;
	}
